...
# user1 = User.create!(first_name: "Steve", last_name: "Nguyen", email: "sampleemail@gmail.com",password: 'a')
# user2 = User.create!(first_name: "Test", last_name: "Subject", email: "randomemail@gmail.com",password: 'b')
